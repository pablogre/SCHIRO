    ...
    def formatear_factura_termica(self, factura):
        ...
        try:
            ...
            if hasattr(factura, 'detalles') and factura.detalles:
                ...
                for detalle in factura.detalles:
                    ...
                    try:
                        ...
                        # Para Factura B: mostrar precios CON IVA
                        if es_factura_b:
                            ...
                            # Para Factura A y C: mostrar precios SIN IVA (como antes)
            ...
            try:
                ...
                # Para Factura B: Solo mostrar TOTAL
                if es_factura_b:
                    lineas.append(self.linea_separadora())
                    lineas.append(self.justificar_texto("TOTAL:", f"${total:,.2f}"))
                else:
                    # Para Factura A y C: Mostrar SUBTOTAL, IVA discriminado y TOTAL
            ...
            if cae:
                ...
                # Para Factura B: Agregar "I.V.A Contenido"
                es_factura_b = str(factura.tipo_comprobante) in ['6', '06']
                if es_factura_b:
                    iva_total = float(getattr(factura, 'iva', 0))
